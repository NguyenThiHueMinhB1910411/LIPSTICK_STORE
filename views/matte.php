...
<main>
    ...
    <h2 class="text-center ">Matte lipstick</h2>
    ...
    <section>
        ...
        <div class="container mt-5">
            <ul class="pagination justify-content-center">
                ...
                <li class="page-item"><a class="page-link" href="/cream">Back</a></li>
        ...
        <li class="page-item"><a class="page-link" href="moisturizing.html">4</a></li> -->
                <li class="page-item"><a class="page-link" href="/gloss">Next</a></li>
            </ul>
